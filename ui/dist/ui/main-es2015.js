...
MenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MenuComponent, selectors: [["app-menu"]], decls: 11, vars: 5, consts: [["color", "accent"], ["mat-fab", "", "color", "accent", "aria-label", "Example icon button with a home icon"], [3, "routerLink"], [1, "example-spacer"], [4, "ngIf"], ["class", "btn", "mat-raised-button", "", "color", "accent", 3, "click", 4, "ngIf"], ["mat-raised-button", "", "color", "accent", 3, "matMenuTriggerFor"], ["yPosition", "below"], ["belowMenu", "matMenu"], ["mat-menu-item", ""], ["mat-raised-button", "", "color", "accent", 1, "btn"], ["mat-raised-button", "", "color", "accent", 1, "btn", 3, "click"]], template: function MenuComponent_Template(rf, ctx) { if (rf & 1) {
